...
export const locations: Location[] = [
  ...
  },
  {
    ...
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Wembley is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Wembley searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
    landmarks: ['Wembley Stadium', 'OVO Arena Wembley', 'Wembley Park', 'London Designer Outlet', 'Wembley Central'],
    searchVolume: 'High local search intent'
  },
  {
    slug: 'harrow',
    name: 'Harrow',
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Harrow is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Harrow searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Brent is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Brent searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Kenton is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Kenton searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Kingsbury is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Kingsbury searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Neasden is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Neasden searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Willesden is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Willesden searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Kilburn is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Kilburn searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Cricklewood is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Cricklewood searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Colindale is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Colindale searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Edgware is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Edgware searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Burnt Oak is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Burnt Oak searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Queensbury is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Queensbury searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Hendon is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Hendon searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Golders Green is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Golders Green searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'West Hampstead is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + West Hampstead searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Maida Vale is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Maida Vale searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'St John\'s Wood is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + St John\'s Wood searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Stanmore is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Stanmore searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Pinner is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Pinner searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Northwood is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Northwood searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Ruislip is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Ruislip searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Greenford is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Greenford searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    avgRent: 'Varies (London market)',
    keyIndustries: ['Local Services', 'Retail', 'Hospitality', 'Professional Services', 'Health & Wellness'],
    description: 'Northolt is a busy North West London area with a strong mix of residential neighbourhoods, high‑street commerce, and local services. Customers here typically search on mobile and choose quickly based on proximity, reviews, and clear service information.',
    businessLandscape: 'Local demand is driven by households, commuters, and community hubs such as stations, parks, schools, and shopping streets. That means competition is often local-to-local: similar businesses targeting the same postcodes and ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps you show up for service + Northolt searches, map results, and neighbourhood queries that convert fast. Dedicated service-by-location pages also let you rank for long‑tail keywords across nearby postcodes while building topical authority.',
  ...
  },
  {
    ...
    businesses: 'Thousands of local businesses',
    avgRent: 'Varies (London market)',
    keyIndustries: ['Retail', 'Hospitality', 'Professional Services', 'Home Services', 'Health & Wellness'],
    description: 'Watford is a major Hertfordshire town on London’s north‑west edge, with a busy town centre, strong commuter links, and a growing mix of independent businesses and national brands. It’s a competitive local market where customers compare options quickly on Google, Maps, and review platforms before they call or visit.',
    businessLandscape: 'The local economy spans retail, hospitality, home services, professional services, health & wellness, and trades, with demand driven by commuters, families, and visitors. Businesses that show up consistently across search, maps, and reviews win more calls, bookings, and walk‑ins—especially for ‘near me’ searches.',
    whyLocalSeo: 'Local SEO helps Watford businesses appear in the map pack and organic results for high‑intent searches (e.g., service + Watford, emergency requests, same‑day needs). With the right pages, citations, and review strategy, you can outrank bigger brands and capture customers ready to buy.',
